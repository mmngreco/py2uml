...
latex_documents = [
    (master_doc, 'py2uml.tex', 'py2uml Documentation',
     'COM', 'manual'),
]
...
man_pages = [
    (master_doc, 'py2uml', 'py2uml Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'py2uml', 'py2uml Documentation',
     author, 'py2uml', 'One line description of project.',
     'Miscellaneous'),
]
